...
UI = LOAD 'UserItemRating' USING PigStorage('\t') AS (uid:int, itemid:int, rating:double);
...
it = load 'u.item' using PigStorage('|') as (itemid:int,itname:chararray,edate:chararray,vedate:chararray,imdburl:chararray,ug:int,f1:int,f2:int,f3:int,f4:int,f5:int,f6:int,f7:int,f8:int,f9:int,f10:int,f11:int,f12:int,f13:int,f14:int,f15:int,f16:int,f17:int,f18:int);
